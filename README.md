...
当前main为0.7.0-dev/code8，尚未正式发布。普通记录功能继续离线使用；可选AI功能在你配置DeepSeek API Key并发送消息时联网。
...
[下载 v0.6.0](https://github.com/lukino0737/daybook/releases/tag/v0.6.0) · [使用说明](docs/USAGE.md) · [构建方法](docs/BUILD.md)
