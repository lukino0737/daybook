...
0.6.0-dev / code 7 在独立提醒、统一列表、日历显示和后台引导基础上，新增事项及便签正文内插图、图片查看和完整图片备份。Room6 / ZIP中的JSON6清单兼容旧数据和JSON1–5备份；无网络或新依赖。本批只提交代码和验收，不提供新安装包或公开发布。隐私便签待另行确认，拖动排序已取消。范围和实际验收见[图片实施记录](docs/V0.6-IMAGES.md)；[提醒第一批记录](docs/V0.6-M1.md)保留。

## 安装与上手

[下载 v0.5.0](https://github.com/lukino0737/daybook/releases/tag/v0.5.0) · [使用说明](docs/USAGE.md) · [构建方法](docs/BUILD.md)
