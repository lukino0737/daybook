...
更新：2026-09-23。**用户已说“开始执行”，v0.7按docs/V0.7-AI.md实施中。第一阶段会话基础已完成本地验收；完整辅助版尚未完成。v0.6标签和发布附件未动。**
...
- Git实施起点main=7ccec1c；本阶段提交号与推送/CI状态以实际git和后续记录为准。专用API35模拟器5554当前运行，升级专用5556未启动；只覆盖安装原签名QA包，不卸载/清库。切勿运行旧升级seed。
