...
class BackupCodecTest {
    ...
    @Test fun readsV2WithEmptyTagsAndRejectsV3MissingTags() {
        ...
        val v2 = current.replace("\"formatVersion\": 6", "\"formatVersion\": 2").replace("    \"tags\": [],\n", "")
    ...
    @Test fun rejectsMalformedUnknownAndTruncatedBackups() {
        ...
        listOf("not JSON", valid.take(valid.length / 2), valid.replace("\"formatVersion\": 6", "\"formatVersion\": 9"),
